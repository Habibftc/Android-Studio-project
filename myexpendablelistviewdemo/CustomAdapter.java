...
public class CustomAdapter extends BaseExpandableListAdapter {
    ...
    CustomAdapter(Context context,List<String> listDataHeader,HashMap<String,List<String>> listDataChild){
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView textView =view.findViewById(R.id.headerTextId);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView textView = view.findViewById(R.id.childTextId);
